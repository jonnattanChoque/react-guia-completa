...
const Formulario = ({saveResumen, setCargando}) => {
    const [datos, saveDatos] = useState({marca: '', year: '', plan: ''});
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <Campo>
                <Label htmlFor="marca" value={marca}>Marca</Label>
                <Select name="marca" id="marca" onChange={obtenerInfo}>
            ...
            <Campo>
                ...
                <Select name="year" value={year} id="year" onChange={obtenerInfo}>
                    <option value=""> -- Seleccione -- </option>
